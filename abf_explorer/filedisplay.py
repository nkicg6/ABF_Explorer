...
class FileDisplay(qt.QWidget):
    ...
    def choose_directory_button_activated(self, command_line_dir: str = None) -> tuple:
        ...
        if selected_dir is None:
            logger.debug(f"button action likely cancelled by user.")
            return (None, None)
